...
export const NBA_SEED_STINTS: SeedPlayerStint[] = [
  ...
  {
    personKey: 'bob_cousy', name: 'Bob Cousy', position: 'PG', team: 'Boston', era: 'sixties',
  ...
  {
    personKey: 'walt_frazier', name: 'Walt Frazier', position: 'PG', team: 'New York', era: 'seventies',
  ...
  {
    personKey: 'maurice_cheeks', name: 'Maurice Cheeks', position: 'PG', team: 'Philadelphia', era: 'eighties',
  ...
  {
    personKey: 'andrew_toney', name: 'Andrew Toney', position: 'SG', team: 'Philadelphia', era: 'eighties',
    stintStartYear: 1980, stintEndYear: 1986, skinTone: 'dark',
  ...
  {
    personKey: 'julius_erving', name: 'Julius Erving', position: 'SF', team: 'Philadelphia', era: 'eighties',
    stintStartYear: 1980, stintEndYear: 1986, skinTone: 'dark',
  ...
  {
    personKey: 'charles_barkley', name: 'Charles Barkley', position: 'PF', team: 'Philadelphia', era: 'eighties',
  ...
  {
    personKey: 'moses_malone', name: 'Moses Malone', position: 'C', team: 'Philadelphia', era: 'eighties',
  ...
  {
    personKey: 'bobby_jones', name: 'Bobby Jones', position: '6MAN', team: 'Philadelphia', era: 'eighties',
  ...
  {
    personKey: 'magic_johnson', name: 'Magic Johnson', position: 'PG', team: 'Los Angeles', era: 'eighties',
  ...
  {
    personKey: 'byron_scott', name: 'Byron Scott', position: 'SG', team: 'Los Angeles', era: 'eighties',
  ...
  {
    personKey: 'james_worthy', name: 'James Worthy', position: 'SF', team: 'Los Angeles', era: 'eighties',
  ...
  {
    personKey: 'ac_green', name: 'A.C. Green', position: 'PF', team: 'Los Angeles', era: 'eighties',
  ...
  {
    personKey: 'kareem_abdul_jabbar', name: 'Kareem Abdul-Jabbar', position: 'C', team: 'Los Angeles', era: 'eighties',
    stintStartYear: 1980, stintEndYear: 1989, skinTone: 'dark',
  ...
  {
    personKey: 'michael_cooper', name: 'Michael Cooper', position: '6MAN', team: 'Los Angeles', era: 'eighties',
    stintStartYear: 1980, stintEndYear: 1989, skinTone: 'dark',
  ...
  {
    personKey: 'ron_harper', name: 'Ron Harper', position: 'PG', team: 'Chicago', era: 'nineties',
  ...
  {
    personKey: 'michael_jordan', name: 'Michael Jordan', position: 'SG', team: 'Chicago', era: 'nineties',
  ...
  {
    personKey: 'scottie_pippen', name: 'Scottie Pippen', position: 'SF', team: 'Chicago', era: 'nineties',
    stintStartYear: 1990, stintEndYear: 1998, skinTone: 'dark',
  ...
  {
    personKey: 'dennis_rodman', name: 'Dennis Rodman', position: 'PF', team: 'Chicago', era: 'nineties',
  ...
  {
    personKey: 'luc_longley', name: 'Luc Longley', position: 'C', team: 'Chicago', era: 'nineties',
  ...
  {
    personKey: 'toni_kukoc', name: 'Toni Kukoč', position: '6MAN', team: 'Chicago', era: 'nineties',
  ...
  {
    personKey: 'john_stockton', name: 'John Stockton', position: 'PG', team: 'Utah', era: 'nineties',
  ...
  {
    personKey: 'jeff_hornacek', name: 'Jeff Hornacek', position: 'SG', team: 'Utah', era: 'nineties',
  ...
  {
    personKey: 'bryon_russell', name: 'Bryon Russell', position: 'SF', team: 'Utah', era: 'nineties',
  ...
  {
    personKey: 'karl_malone', name: 'Karl Malone', position: 'PF', team: 'Utah', era: 'nineties',
  ...
  {
    personKey: 'greg_ostertag', name: 'Greg Ostertag', position: 'C', team: 'Utah', era: 'nineties',
  ...
  {
    personKey: 'antoine_carr', name: 'Antoine Carr', position: '6MAN', team: 'Utah', era: 'nineties',
    stintStartYear: 1994, stintEndYear: 1999, skinTone: 'dark',
  ...
  {
    personKey: 'tony_parker', name: 'Tony Parker', position: 'PG', team: 'San Antonio', era: 'two_thousands',
  ...
  {
    personKey: 'manu_ginobili', name: 'Manu Ginóbili', position: 'SG', team: 'San Antonio', era: 'two_thousands',
  ...
  {
    personKey: 'bruce_bowen', name: 'Bruce Bowen', position: 'SF', team: 'San Antonio', era: 'two_thousands',
  ...
  {
    personKey: 'tim_duncan', name: 'Tim Duncan', position: 'PF', team: 'San Antonio', era: 'two_thousands',
  ...
  {
    personKey: 'david_robinson', name: 'David Robinson', position: 'C', team: 'San Antonio', era: 'two_thousands',
  ...
  {
    personKey: 'robert_horry', name: 'Robert Horry', position: '6MAN', team: 'San Antonio', era: 'two_thousands',
  ...
  {
    personKey: 'derek_fisher', name: 'Derek Fisher', position: 'PG', team: 'Los Angeles', era: 'two_thousands',
  ...
  {
    personKey: 'kobe_bryant', name: 'Kobe Bryant', position: 'SG', team: 'Los Angeles', era: 'two_thousands',
    stintStartYear: 2000, stintEndYear: 2009, skinTone: 'dark',
  ...
  {
    personKey: 'rick_fox', name: 'Rick Fox', position: 'SF', team: 'Los Angeles', era: 'two_thousands',
    stintStartYear: 2000, stintEndYear: 2003, skinTone: 'dark',
  ...
  {
    personKey: 'karl_malone', name: 'Karl Malone', position: 'PF', team: 'Los Angeles', era: 'two_thousands',
  ...
  {
    personKey: 'shaquille_oneal', name: 'Shaquille O’Neal', position: 'C', team: 'Los Angeles', era: 'two_thousands',
  ...
  {
    personKey: 'lamar_odom', name: 'Lamar Odom', position: '6MAN', team: 'Los Angeles', era: 'two_thousands',
  ...
  {
    personKey: 'rajon_rondo', name: 'Rajon Rondo', position: 'PG', team: 'Boston', era: 'two_thousands',
  ...
  {
    personKey: 'ray_allen', name: 'Ray Allen', position: 'SG', team: 'Boston', era: 'two_thousands',
    stintStartYear: 2007, stintEndYear: 2010, skinTone: 'dark',
  ...
  {
    personKey: 'paul_pierce', name: 'Paul Pierce', position: 'SF', team: 'Boston', era: 'two_thousands',
    stintStartYear: 2007, stintEndYear: 2010, skinTone: 'dark',
  ...
  {
    personKey: 'kevin_garnett', name: 'Kevin Garnett', position: 'PF', team: 'Boston', era: 'two_thousands',
    stintStartYear: 2007, stintEndYear: 2010, skinTone: 'dark',
  ...
  {
    personKey: 'kendrick_perkins', name: 'Kendrick Perkins', position: 'C', team: 'Boston', era: 'two_thousands',
    stintStartYear: 2007, stintEndYear: 2010, skinTone: 'dark',
  ...
  {
    personKey: 'glen_davis', name: 'Glen Davis', position: '6MAN', team: 'Boston', era: 'two_thousands',
    stintStartYear: 2007, stintEndYear: 2010, skinTone: 'dark',
  ...
  {
    personKey: 'chauncey_billups', name: 'Chauncey Billups', position: 'PG', team: 'Detroit', era: 'two_thousands',
  ...
  {
    personKey: 'richard_hamilton', name: 'Richard Hamilton', position: 'SG', team: 'Detroit', era: 'two_thousands',
    stintStartYear: 2003, stintEndYear: 2006, skinTone: 'dark',
  ...
  {
    personKey: 'tayshaun_prince', name: 'Tayshaun Prince', position: 'SF', team: 'Detroit', era: 'two_thousands',
    stintStartYear: 2003, stintEndYear: 2006, skinTone: 'dark',
  ...
  {
    personKey: 'rasheed_wallace', name: 'Rasheed Wallace', position: 'PF', team: 'Detroit', era: 'two_thousands',
  ...
  {
    personKey: 'ben_wallace', name: 'Ben Wallace', position: 'C', team: 'Detroit', era: 'two_thousands',
    stintStartYear: 2003, stintEndYear: 2006, skinTone: 'dark',
  ...
  {
    personKey: 'antonio_mcdyess', name: 'Antonio McDyess', position: '6MAN', team: 'Detroit', era: 'two_thousands',
    stintStartYear: 2004, stintEndYear: 2006, skinTone: 'dark',
  ...
  {
    personKey: 'mo_williams', name: 'Mo Williams', position: 'PG', team: 'Cleveland', era: 'two_thousands',
  ...
  {
    personKey: 'larry_hughes', name: 'Larry Hughes', position: 'SG', team: 'Cleveland', era: 'two_thousands',
  ...
  {
    personKey: 'drew_gooden', name: 'Drew Gooden', position: 'PF', team: 'Cleveland', era: 'two_thousands',
  ...
  {
    personKey: 'zydrunas_ilgauskas', name: 'Zydrunas Ilgauskas', position: 'C', team: 'Cleveland', era: 'two_thousands',
  ...
  {
    personKey: 'anderson_varejao', name: 'Anderson Varejão', position: '6MAN', team: 'Cleveland', era: 'two_thousands',
  ...
  {
    personKey: 'mario_chalmers', name: 'Mario Chalmers', position: 'PG', team: 'Miami', era: 'twenty_tens',
  ...
  {
    personKey: 'dwyane_wade', name: 'Dwyane Wade', position: 'SG', team: 'Miami', era: 'twenty_tens',
    stintStartYear: 2010, stintEndYear: 2014, skinTone: 'dark',
  ...
  {
    personKey: 'lebron_james', name: 'LeBron James', position: 'SF', team: 'Miami', era: 'twenty_tens',
    stintStartYear: 2010, stintEndYear: 2014, skinTone: 'dark',
  ...
  {
    personKey: 'chris_bosh', name: 'Chris Bosh', position: 'PF', team: 'Miami', era: 'twenty_tens',
    stintStartYear: 2010, stintEndYear: 2014, skinTone: 'dark',
  ...
  {
    personKey: 'chris_andersen', name: 'Chris Andersen', position: 'C', team: 'Miami', era: 'twenty_tens',
  ...
  {
    personKey: 'ray_allen', name: 'Ray Allen', position: '6MAN', team: 'Miami', era: 'twenty_tens',
  ...
  {
    personKey: 'stephen_curry', name: 'Stephen Curry', position: 'PG', team: 'Golden State', era: 'twenty_tens',
  ...
  {
    personKey: 'klay_thompson', name: 'Klay Thompson', position: 'SG', team: 'Golden State', era: 'twenty_tens',
    stintStartYear: 2014, stintEndYear: 2019, skinTone: 'light',
  ...
  {
    personKey: 'kevin_durant', name: 'Kevin Durant', position: 'SF', team: 'Golden State', era: 'twenty_tens',
  ...
  {
    personKey: 'draymond_green', name: 'Draymond Green', position: 'PF', team: 'Golden State', era: 'twenty_tens',
  ...
  {
    personKey: 'andrew_bogut', name: 'Andrew Bogut', position: 'C', team: 'Golden State', era: 'twenty_tens',
  ...
  {
    personKey: 'andre_iguodala', name: 'Andre Iguodala', position: '6MAN', team: 'Golden State', era: 'twenty_tens',
    stintStartYear: 2014, stintEndYear: 2019, skinTone: 'dark',
  ...
  {
    personKey: 'jrue_holiday', name: 'Jrue Holiday', position: 'PG', team: 'Milwaukee', era: 'twenty_twenties',
  ...
  {
    personKey: 'khris_middleton', name: 'Khris Middleton', position: 'SG', team: 'Milwaukee', era: 'twenty_twenties',
    stintStartYear: 2020, stintEndYear: 2021, skinTone: 'dark',
  ...
  {
    personKey: 'wesley_matthews', name: 'Wesley Matthews', position: 'SF', team: 'Milwaukee', era: 'twenty_twenties',
    stintStartYear: 2020, stintEndYear: 2021, skinTone: 'dark',
  ...
  {
    personKey: 'giannis_antetokounmpo', name: 'Giannis Antetokounmpo', position: 'PF', team: 'Milwaukee', era: 'twenty_twenties',
    stintStartYear: 2020, stintEndYear: 2021, skinTone: 'dark',
  ...
  {
    personKey: 'brook_lopez', name: 'Brook Lopez', position: 'C', team: 'Milwaukee', era: 'twenty_twenties',
  ...
  {
    personKey: 'bobby_portis', name: 'Bobby Portis', position: '6MAN', team: 'Milwaukee', era: 'twenty_twenties',
    stintStartYear: 2020, stintEndYear: 2021, skinTone: 'dark',
